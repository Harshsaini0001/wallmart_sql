...
| :---------------------- | :-------------------------------------- | :------------- |
| invoice_id              | Invoice of the sales made               | VARCHAR(25)    |
...
| payment_method                 | The total amount paid                   | DECIMAL(7, 2) |
| cogs                    | Cost Of Goods sold                      | DECIMAL(11, 2) |
| gross_margin_percentage | Gross margin percentage                 | FLOAT(11, 9)   |
| gross_income            | Gross Income                            | DECIMAL(7, 4) |
